    ...
    private void MovePlayer(Vector3 movement)
    {
        ...
        else
        {
            ...
            if (screenPosition.x < 20)
            {
                ...
                transform.position = camera.ScreenToWorldPoint(new Vector3(20, screenPosition.y, 0));
                transform.position += new Vector3(0, 0, 10);
            }
            else if (screenPosition.x > Screen.width - 20)
            {
                transform.position = camera.ScreenToWorldPoint(new Vector3(Screen.width - 20, screenPosition.y, 0));
                transform.position += new Vector3(0, 0, 10);
            }
        }
    }
